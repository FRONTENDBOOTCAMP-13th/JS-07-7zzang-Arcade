...
- 과거 오락실의 느낌을 살린 레트로풍 메인 화면으로, 유저가 동전을 투입하면 게임 선택 화면이 활성화됩니다. - 미니 게임 4종의 각 아이콘을 클릭하면 해당 게임 페이지로 이동합니다. - 우측 상단의 라디오 아이콘을 통해 BGM을 On/Off할 수 있습니다.
<div align
|                                   실행 화면                                    |
| :----------------------------------------------------------------------------: |
| ![메인](https://github.com/user-attachments/assets/a5feba57-c5ed-40ca-87b0-4cf0dceec429) |
...
- 구멍에서 무작위로 튀어나오는 두더지를 뿅망치로 빠르게 클릭하여 점수를 올리는 반응형 게임입니다.
  - **제한 시간 30초 내**로 최대한 높은 점수를 획득하는 것이 목표입니다.
